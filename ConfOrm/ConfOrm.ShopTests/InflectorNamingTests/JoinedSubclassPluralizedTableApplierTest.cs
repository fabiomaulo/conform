...
{
	public class JoinedSubclassPluralizedTableApplierTest
	{
		...
		{
			Executing.This(() => new JoinedSubclassPluralizedTableApplier(null)).Should().Throw<ArgumentNullException>();
		}
		...
		public void WhenApplyThenCallInflector()
		{
			...
			var applier = new JoinedSubclassPluralizedTableApplier(inflector.Object);
			var mapper = new Mock<IJoinedSubclassMapper>();
