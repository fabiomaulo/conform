...
{
	public class ManyToManyCustomizersCallingTest
	{
		...
		public void WhenRegisteredCustomizerForBagThenCallElementMapperAction()
		{
			...
			mapper.Class<Person>(cm => cm.Bag(person => person.Pets, cpm => { }, cerm => cerm.ManyToMany(em => called = true)));
		...
		public void WhenRegisteredCustomizerForSetThenCallElementMapperAction()
		{
			...
			var called = false;
			var mapper = new Mapper(orm.Object);
			mapper.Class<Person>(cm => cm.Set(person => person.Pets, cpm => { }, cerm => cerm.ManyToMany(em => called = true)));
		...
		public void WhenRegisteredCustomizerForListThenCallElementMapperAction()
		{
			...
			var called = false;
			var mapper = new Mapper(orm.Object);
			mapper.Class<Person>(cm => cm.List(person => person.Pets, cpm => { }, cerm => cerm.ManyToMany(em => called = true)));
		...
		public void WhenRegisteredCustomizerForDictionaryThenCallElementMapperAction()
		{
			...
			var mapper = new Mapper(orm.Object);
			mapper.Class<Person>(
				cm => cm.Map(person => person.Farm, cpm => { }, mkrm => { }, cerm => cerm.ManyToMany(em => called = true)));
