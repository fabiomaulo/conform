...
namespace ConfOrmTests.NH.MapperTests
{
	public class ManyToManyApplyCascade
	{
		...
		private Mock<IDomainInspector> GetMockedDomainInspector()
		{
			...
			orm.Setup(m => m.ApplyCascade(It.Is<Type>(t => t == typeof(Person)), It.IsAny<MemberInfo>(), It.Is<Type>(t => t == typeof(Animal)))).Returns(CascadeOn.Persist);
		...
		public void IntegrationWithObjectRelationalMapper()
		{
			...
			orm.Cascade<Person, Animal>(CascadeOn.Persist);
