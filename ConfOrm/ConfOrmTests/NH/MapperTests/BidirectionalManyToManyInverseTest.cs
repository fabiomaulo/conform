...
{
	public class BidirectionalManyToManyInverseTest
	{
		private class User
		{
		...
		private Mock<IDomainInspector> GetMockedDomainInspector()
		{
			...
			orm.Setup(m => m.IsMasterManyToMany(It.Is<Type>(t => t == typeof(User)), It.Is<Type>(t => t == typeof(Role)))).Returns(true);
			orm.Setup(m => m.IsMasterManyToMany(It.Is<Type>(t => t == typeof(UserMap)), It.Is<Type>(t => t == typeof(RoleMap)))).Returns(true);
			orm.Setup(m => m.IsMasterManyToMany(It.Is<Type>(t => t == typeof(UserMix)), It.Is<Type>(t => t == typeof(RoleMix)))).Returns(true);
			orm.Setup(m => m.IsMasterManyToMany(It.Is<Type>(t => t == typeof(Person)), It.Is<Type>(t => t == typeof(Person)))).Returns(true);
		...
		[Test]
		public void WhenPlainCollectionShouldUseInverseOnlyForNoMaster()
		{
			...
			hbmUserRoles.Inverse.Should().Be.False();
			hbmRoleUsers.Inverse.Should().Be.True();
		}

		[Test]
		public void WhenDictionariesShouldUseInverseOnlyForNoMaster()
		{
			var orm = GetMockedDomainInspector();
			var mapper = new Mapper(orm.Object);
		...
		[Test]
		public void WhenMixShouldUseInverseOnlyForNoMaster()
		{
			var orm = GetMockedDomainInspector();
			var mapper = new Mapper(orm.Object);
		...
		public void WhenCircularReferenceShouldNotMatch()
		{
			...
			hbmPersonFriends.Inverse.Should().Be.False();
		}
	}
}