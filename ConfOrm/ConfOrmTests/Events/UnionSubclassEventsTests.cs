...
{
	public class UnionSubclassEventsTests
	{
		...
		public void CallBeforeEventBeforeFirstPatternApplier()
		{
			...
			orm.TablePerConcreteClass<MyClass>();
			
			var patternsAppliersHolder = new EmptyPatternsAppliersHolder();
			patternsAppliersHolder.UnionSubclass.Add(t=> true, (t, cam) => callSequence.Add("pa"));
			
			var mapper = new Mapper(orm, patternsAppliersHolder);
			mapper.BeforeMapUnionSubclass += (di, t, cam) => callSequence.Add("beforeevent");
		...
		public void CallAfterEventAfterLastCustomizer()
		{
			...
			var patternsAppliersHolder = new EmptyPatternsAppliersHolder();
			var mapper = new Mapper(orm, patternsAppliersHolder);
			mapper.AfterMapUnionSubclass += (di, t, cam) => callSequence.Add("afterevent");

			mapper.UnionSubclass<Inherited>(ca => callSequence.Add("c1"));
			mapper.UnionSubclass<Inherited>(ca => callSequence.Add("c2"));
			mapper.CompileMappingFor(new[] { typeof(MyClass), typeof(Inherited) });
